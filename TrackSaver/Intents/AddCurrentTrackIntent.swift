...
struct AddCurrentTrackIntent: AppIntent {
    ...
    private var isSchemaTraining: Bool {
        // Detect common training/extension contexts where live work must not run.
    ...
    private func hasAuthContext() -> Bool {
        ...
        // Require at least an access or refresh token to avoid hitting SpotifyAuthManager in training.
    ...
    static var description: IntentDescription? {
        IntentDescription("Speichert den aktuell spielenden Song über TrackSaver.")
    }
