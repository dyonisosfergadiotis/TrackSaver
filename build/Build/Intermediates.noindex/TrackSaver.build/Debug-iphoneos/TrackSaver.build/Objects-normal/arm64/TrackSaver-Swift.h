...
#ifndef TRACKSAVER_SWIFT_H
#define TRACKSAVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrackSaver",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10TrackSaver18SpotifyAuthManager")
@interface SpotifyAuthManager : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class ASWebAuthenticationSession;
@interface SpotifyAuthManager (SWIFT_EXTENSION(TrackSaver)) <ASWebAuthenticationPresentationContextProviding>
